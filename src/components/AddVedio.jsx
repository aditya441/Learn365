        ...
        return(
            <div>
                <div className='vedio-detail'>
                    ...
                    <label htmlFor="" className='col-xs-2 vedio-title'>Vedio title</label> <input type="text" className='form-control col-xs-6 course-input' placeholder='enter video title'/>

    ...
    render(){
        ...
        return(
            ...
            <div className="welcome">
                    <h2 style={{fontWeight:'bolder'}}>Welcome!</h2>
                ...
                <div className="row justify-content-around align-items-center">
                    <div className="col-md-4 wf2 order-3">
                        ...
                        <p style={{fontSize:'20px',marginTop:'65px'}}>Teach what you Love.Learn365 gives you the tools to create an online course.</p> 
                    ...
                    <div className="col-md-4 wf1 order-4">
                        <h2>Be a Learner</h2>
                        <p style={{fontSize:'20px',marginTop:'65px'}}>Get unlimited access to the 100's of courses that Learn365 provides you.</p>
                        <div className="FormField">
                            <Link to='/Courses'>
